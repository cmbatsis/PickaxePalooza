package net.mcreator.pickaxepalooza;
...
@Mod("pickaxepalooza")
public class PickaxepaloozaMod {
	public static final Logger LOGGER = LogManager.getLogger(PickaxepaloozaMod.class);
	public static final String MODID = "pickaxepalooza";

	public PickaxepaloozaMod() {
		...
		PickaxepaloozaModMenus.REGISTRY.register(bus);
